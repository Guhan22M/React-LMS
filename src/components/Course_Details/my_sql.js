                ...
                <ul className="list-group list-group-flush">
                    <li className='list-group-item'>Programming with Harry
                        <span className='float-end'>
                            ...
                            <button onClick={()=>addToCart("MySQL","Programming with Harry","https://youtu.be/_MF8L7ZxwRE?si=gHt6RZRgN_vCSz_g")} className='btn btn-sm btn-primary m-2'><i className='bi bi-cart-plus'></i></button>
                        </span>
                    </li>
                    <li className='list-group-item'>CodeIO
                        <span className='float-end'>
                            ...
                            <button onClick={()=>addToCart("MySQL","CodeIO","https://youtu.be/fmSnLiAv-zc?si=ZySSVaYfOQmey5eP")} className='btn btn-sm btn-primary m-2'><i className='bi bi-cart-plus'></i></button>
                        </span>
                    </li>
                    <li className='list-group-item'>BROCODE
                        <span className='float-end'>
                            ...
                            <button onClick={()=>addToCart("MySQL","BROCODE","https://youtu.be/87SH2Cn0s9A?si=71qleO6tq2VEsjfR")} className='btn btn-sm btn-primary m-2'><i className='bi bi-cart-plus'></i></button>
                        </span>
                    </li>
                    <li className='list-group-item'>Freecodecamp
                        <span className='float-end'>
                            ...
                            <button onClick={()=>addToCart("MySQL","Freecodecamp","https://youtu.be/KJgsSFOSQv0?si=aB4w4wr8750PXbag")} className='btn btn-sm btn-primary m-2'><i className='bi bi-cart-plus'></i></button>
                        </span>
                    </li>
                    <li className='list-group-item'>Programmiz
                        <span className='float-end'>
                            ...
                            <button onClick={()=>addToCart("MySQL","Programmiz","https://youtu.be/0Sg6QHmlFJE?si=lUt5lH_rj5LAlpwH")} className='btn btn-sm btn-primary m-2'><i className='bi bi-cart-plus'></i></button>
                        </span>
                    </li>
                </ul>
            </div>
